...
if(isset($_POST['idArrival']) && isset($_POST['Arrival_date']) && isset($_POST['Logistics_idLogistics'])){
    ...
    $query ="INSERT INTO Arrival VALUES('$idArrival', '$Arrival_date', '$Logistics_idLogistics')";
