...
if(isset($_POST['idCommand']) && isset($_POST['Salary']) && isset($_POST['Contract_for_ship_idContract_for_ship']) && isset($_POST['Rank_idRank']) ){
    ...
    $query ="INSERT INTO command VALUES('$idCommand','$Salary','$Contract_for_ship_idContract_for_ship','$Rank_idRank')";
