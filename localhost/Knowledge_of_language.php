...
if(isset($_POST['Language']) && isset($_POST['Proficiency'])
    ...
    $query ="INSERT INTO Knowledge_of_language (Language, Proficiency, Mark , Profile_sailor_idProfile_sailor) VALUES('$Language', '$Proficiency', '$Mark' , '$Profile_sailor_idProfile_sailor')";
